...
pub fn encode_into(
    ...
    unsafe {
        ...
        for chunk in src[..full_chunks * 5].chunks_exact(5) {
        ...
        match remainder {
            ...
            2 => {
                let b0 = src[src.len() - 2] as u32;
                let b1 = src[src.len() - 1] as u32;
                let c0 = ((b0 >> 3) & 0x1F) as usize;
                let c1 = (((b0 << 2) | (b1 >> 6)) & 0x1F) as usize;
                let c2 = ((b1 >> 1) & 0x1F) as usize;
            ...
            3 => {
                let b0 = src[src.len() - 3] as u32;
                let b1 = src[src.len() - 2] as u32;
                let b2 = src[src.len() - 1] as u32;
                let c0 = ((b0 >> 3) & 0x1F) as usize;
                let c1 = (((b0 << 2) | (b1 >> 6)) & 0x1F) as usize;
                let c2 = ((b1 >> 1) & 0x1F) as usize;
                let c3 = (((b1 << 4) | (b2 >> 4)) & 0x1F) as usize;
            ...
            4 => {
                let b0 = src[src.len() - 4] as u32;
                let b1 = src[src.len() - 3] as u32;
                let b2 = src[src.len() - 2] as u32;
                let b3 = src[src.len() - 1] as u32;
                let c0 = ((b0 >> 3) & 0x1F) as usize;
                let c1 = (((b0 << 2) | (b1 >> 6)) & 0x1F) as usize;
                let c2 = ((b1 >> 1) & 0x1F) as usize;
                let c3 = (((b1 << 4) | (b2 >> 4)) & 0x1F) as usize;
