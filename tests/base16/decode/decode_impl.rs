...
fn test_single_byte_zero() {
    let config = create_config();
    let result = decode16(&config, b"00");
...
fn test_single_byte_all_ones() {
    ...
    let result = decode16(&config, b"FF");
...
fn test_two_bytes() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"0AFF");
...
fn test_three_bytes() {
    let config = create_config();
    let result = decode16(&config, b"010203");
...
fn test_four_bytes() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"DEADBEEF");
...
fn test_hello() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"48656C6C6F");
...
fn test_all_zeros() {
    let config = create_config();
    let result = decode16(&config, b"00000000");
...
fn test_all_ones() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"FFFFFFFF");
...
fn test_invalid_odd_length() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"F");
...
fn test_invalid_character() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"GG");
    assert!(matches!(
        result,
...
fn test_invalid_character_at_second_position() {
    let config = create_config_uppercase();
    let result = decode16(&config, b"FG");
    assert!(matches!(
        result,
...
fn test_invalid_high_byte() {
    let config = create_config_uppercase();
    let result = decode16(&config, &[b'F', 0xFF]);
    assert!(matches!(
        result,
...
fn test_invalid_character_at_different_positions() {
    ...
    let result = decode16(&config, b"!FFFFFFF");
    assert!(matches!(result, Err(Base16Error::InvalidCharacter(_, 0))));
