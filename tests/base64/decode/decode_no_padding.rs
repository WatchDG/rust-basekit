use basekit::base64::{Base64DecodeConfig, DECODE_TABLE_BASE64, decode64};
...
fn test_decode_two_bytes_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"Zm8");
...
fn test_decode_three_bytes_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"Zm9v");
...
fn test_decode_four_bytes_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"Zm9vYg");
...
fn test_decode_five_bytes_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"Zm9vYmE");
...
fn test_decode_six_bytes_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"Zm9vYmFy");
    assert_eq!(
...
fn test_decode_hello_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"SGVsbG8");
...
fn test_decode_all_zeros_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"AAAA");
...
fn test_decode_consistency_multi_4() {
    ...
    let unpadded = decode64(&config_no_pad, b"Zm9vYmFy").unwrap();
    let padded = decode64(&config_with_pad, b"Zm9vYmFy").unwrap();
...
fn test_decode_longer_string_no_padding() {
    let config = create_config_no_padding();
    let result = decode64(&config, b"SGVsbG8gV29ybGQh");
...
fn test_decode_binary_patterns_no_padding() {
    ...
    for (encoded, expected) in patterns {
        let result = decode64(&config, encoded).unwrap();
        assert_eq!(
            Vec::<u8>::from(result),
            expected,
            "Failed for {:?}",
