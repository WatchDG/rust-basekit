...
fn test_single_byte() {
    let config = create_config();
    let result = encode_v1(&config, &[102]);
...
fn test_two_bytes() {
    let config = create_config();
    let result = encode_v1(&config, &[102, 111]);
...
fn test_three_bytes() {
    let config = create_config();
    let result = encode_v1(&config, &[102, 111, 111]);
...
fn test_four_bytes() {
    let config = create_config();
    let result = encode_v1(&config, &[102, 111, 111, 98]);
...
fn test_five_bytes() {
    let config = create_config();
    let result = encode_v1(&config, &[102, 111, 111, 98, 97]);
...
fn test_six_bytes() {
    let config = create_config();
    let result = encode_v1(&config, &[102, 111, 111, 98, 97, 114]);
