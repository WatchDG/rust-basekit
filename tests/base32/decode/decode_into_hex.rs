use basekit::base32::{Base32DecodeConfig, Base32Error, DECODE_TABLE_BASE32_HEX, decode32_into};
...
#[test]
fn test_round_trip() {
    use basekit::base32::{ALPHABET_BASE32_HEX, Base32EncodeConfig, encode32_into};
